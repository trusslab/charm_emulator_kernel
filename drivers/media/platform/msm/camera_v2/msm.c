	...
	bool valid_prio, unsigned int cmd, void *arg)
{
	...
	/*FIXME*/ //Charm this is real bug and this is temp patch
	void * __user argusr=arg;
	struct msm_v4l2_event_data event_data_instack;
	event_data=&event_data_instack;
	if(copy_from_user((void*)event_data, argusr , sizeof(event_data_instack))){
		return -EINVAL;
	}
	//Charm end
